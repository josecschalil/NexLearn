...
const CoursePage = () => {
  ...
  <div className="max-w-4xl mx-auto bg-white py-8 rounded-xl shadow-md p-6 border">
    ...
    <div className="flex items-center justify-between flex-wrap gap-4">
      <div className="text-md xs:text-xl sm:text-3xl font-bold text-gray-800">
        ...
        <span className="text-gray-500 line-through text-sm xs:text-lg sm:text-xl font-semibold ml-1 md:ml-2">₹{course.price}</span>
    ...
    {/* Portions Covered */}
    <div className="mt-2">
      <h4 className="text-md xs:text-xl sm:text-2xl font-bold text-gray-700 mb-2">Portions Covered in the Course</h4>
    ...
    <div className="mt-4 pt-6 ">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
        {[
          ...
          <div key={index} className="text-center bg-gray-50 border-t-4 border-teal-700 rounded-2xl py-4 shadow-md">
    ...
    <div className="mt-8  pt-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <ul className="list-decimal pl-4  space-y-1 sm:space-y-4 text-sm text-justify xs:text-md sm:text-[15px] font-jakarta2   text-gray-800">
        ...
        <ul className="list-decimal pl-4  space-y-1 text-sm  sm:space-y-4  text-justify max-xs:text-md sm:text-[15px]   font-jakarta2   text-gray-800">
